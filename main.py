...
usuario = obtener_usuario.stdout.strip()
...
verificador1 = py.confirm("""Este script realiza actividades de recolección de información y escaneo limitado de puertos al host scanme.nmap.org.
...
De no tenerlo y continuar habrá repercusiones legales.""", buttons=["Aceptar", "Salir"])

if verificador1 == "Aceptar":
